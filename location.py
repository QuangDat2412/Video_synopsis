...
class NewLocation:
    ...
    def json2obj(self, loc_json):
        ...
        temp_new_location = NewLocation(
            origin_frame=temp_origin_frame, position=temp_position, target_id=temp_target_id)
    ...
    def get_file_name(self):
        path = './temp_file/targets_image/target_' + str(self.target_id)
...
class Position:
    ...
    def json2obj(self, position_json):
        ...
        temp_position.set_tuple(top_left_x, top_left_y,
